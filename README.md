...
- [SearXNG](https://docs.searxng.org/) `⚠` - Internet metasearch engine which aggregates results from various search services and databases. ([Source Code](https://github.com/searxng/searxng/)) `AGPL-3.0` `Python/Docker`
